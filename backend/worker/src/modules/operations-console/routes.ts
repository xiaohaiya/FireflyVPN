  ...
  app.post("/:adminRoute/api/subscriptions", async (context) => {
    ...
    await writeAdminAudit(context.env, context.req.raw, {
      ...
      detail: {
        ...
        externalHealthEnabled: source.externalHealthEnabled === 1,
      },
    });
  ...
  app.put("/:adminRoute/api/settings", async (context) => {
    ...
    await writeAdminAudit(context.env, context.req.raw, {
      ...
      detail: {
        ...
        adminLoginRateLimitEnabled: settings.security.adminLoginRateLimitEnabled,
        adminLoginRateLimitPerMinute: settings.security.adminLoginRateLimitPerMinute,
      },
    });
